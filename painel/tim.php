...
define ('MEMORY_LIMIT', '70M');				// set PHP memory limit
define ('MAX_FILE_SIZE', 7000000);			// file size limit to prevent possible DOS attacks (roughly 1.5 megabytes)
...
$percentage = (double) abs (get_request('p', 0));

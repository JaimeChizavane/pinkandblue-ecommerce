<div class="dev-container">	
	<?php 
		$uteis 		= new Uteis;
		$id 		= (int) $_GET['id'];
		$uteis->query('SELECT * FROM proprietarios WHERE id =:id');
		$uteis->bind(':id',$id);
		$uteis->execute();
	...
	<div class="dev-row-padding dev-margin-bottom" style="">
		<div class="dev-sidebar dev-collapse dev-border dev-grey" style="z-index:43;width:270px;" >
			<div class="dev-bar-block dev-animate-right" id="proprietarios" >
				<div class="dev-bar-item dev-border-bottom dev-white">Proprietarios - Salvar</div>
				<ul class="dev-ul dev-hoverable dev-large j_detalhes_da_proprietario">		
					<li style="padding:0;"><a href="#descricao_da_proprietario" class="dev-bar-item dev-large">Descrição</a></li>
					<li style="padding:0;"><a href="#foto_principal_da_proprietario" class="dev-bar-item dev-large">Foto Principal</a></li>
				</ul>	
			</div>	
		</div>
		<div class="dev-main" style="margin-left:270px;"><!--Aqui Inicia A Div para cadastro dos dados da Proprietario-->			
			<div class="dev-border dev-white dev-padding">
				<h1 class="dev-border-bottom dev-text-grey" id="descricao_da_proprietario" style="margin-bottom:0;">Descrição</h1>
				<form name="salva_proprietario" class="" style="margin-top:0;margin-bottom:0;" method="POST" id="salva_proprietario" action="<?php $_SERVER["PHP_SELF"];?>">
					<div class="dev-row-padding">
						...
						<div class="dev-row-padding" style="margin-left:-16px;margin-right:-16px;">
							<div class="dev-half">
								...
								<input class="dev-input dev-border dev-large dev-round-xlarge" type="text" name="nome" id="nome" value="<?php echo $viewmodel["nome"]?>" placeholder="Informe o Titulo da Proprietario" required>
							</div>
							<div class="dev-half">
								<label class="dev-large" for="nome">Contacto</label>
								<input class="dev-input dev-border dev-large dev-round-xlarge" type="text" name="contacto" id="contacto" value="<?php echo $viewmodel["contacto"]?>" placeholder="Informe o contacto" required>
							</div>
						</div>
						
						<div class="dev-row-padding dev-margin-top" style="margin-left:-16px;margin-right:-16px;">
							<div class="dev-half">
								<label class="dev-large" for="nome">Website</label>
								<input class="dev-input dev-border dev-large dev-round-xlarge" type="text" name="website" id="website" value="<?php echo $viewmodel["website"]?>" placeholder="Informe o Titulo da Proprietario" required>
							</div>
							<div class="dev-half">
								<label class="dev-large" for="email">Email</label>
								<input class="dev-input dev-border dev-large dev-round-xlarge" type="text" name="email" id="email" value="<?php echo $viewmodel["email"]?>" placeholder="Informe o Email da Proprietario" required>
							</div>
						</div>
											
						<div class="dev-margin-top" style="width:100%;">
						...
						<iframe name="richTextField" id="richTextField" style="width:100%; height:300px;background-color:#fff;" class="dev-border dev-large dev-round-xlarge"></iframe>					
					</div>	
						...
						<div class="dev-half">
							<p>
								...
								<select class="dev-select dev-border dev-large dev-round-xlarge" name="tipo" id="tipo" required>
									<option value="" disabled selected>Informe o tipo de proprietario</option>
						...
						<div class="dev-half">
							<p>
								...
								<select class="dev-select dev-border dev-large dev-round-xlarge" name="status" id="status" required>
									<option value="" disabled selected>Informe o status da Proprietario</option>
					...
					<p class="j_proprietario">
						<input type="submit" class="dev-button dev-flat-belize-hole j_salva_proprietario" name="salvar_contacto" value="Salvar&nbsp; ❯">
				...
				<div class="dev-white" style="padding-top:0;">
					<h1 class="dev-border-bottom dev-text-grey" id="foto_principal_da_proprietario" style="margin-bottom:0;margin-top:0;">Foto Principal</h1>
					<form method="POST" name="foto" id="foto" enctype="multipart/form-data">
						<input type="hidden" name="id" value="<?php echo $id;?>">
						<div class="">
							<p>
								<input class="dev-input dev-border dev-round-xlarge" type="file" name="foto">
							</p>
		...
		</div><!--Aqui Finaliza A Div para cadastro dos dados da Proprietario-->
	</div>
</div>
<style>
	button{
...
$(document).ready(function(){
  ...
  $(".j_detalhes_da_proprietario > li > a").on('click', function(event) {
...
var theForm = document.getElementById("salva_proprietario");
...
<script src="<?php echo ROOT_URL;?>assets/controllers/proprietario.js"></script>
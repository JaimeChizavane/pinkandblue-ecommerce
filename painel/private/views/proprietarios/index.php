<div class="dev-container">
	<div class="dev-border dev-white dev-padding dev-margin-bottom">
		<div class="dev-col l3">
				<h1 class="dev-large dev-margin-0"><i class="fa fa-users"></i> Proprietarios - Home</h1>
		</div>
		<div class="dev-col l9">
			...
			<div class="dropdown">
			  ...
			  <div class="dropdown-content">
				<a href="#" class="j_cria_novo_proprietario" data-tipo="<?php echo $_GET["tipo"]?>">Adicionar Novo</a>
			  </div>
			</div>
		</div>
	</div>
...
$(document).ready(function()
{
	$('#results').DataTable({
		...
		'language'			: {
			...
			"sSearch"		: "Pesquisar:",
			"sSearchPlaceholder" : "nome da proprietario...",
			"paginate"		: {
				"first"			: "Primeiro",
				"last"			: "Ultimo",
				"next"			: "Proximo",
		...
		'ajax'		 		: {
			'url' 			: "<?php echo ROOT_URL?>proprietarios/listarProprietarios/",
			'type' 			: 'POST',
			'data'			: {
	...
	{
		$.ajax({
			url 		: "<?php echo ROOT_URL?>proprietarios/removerCategorias/",
			method 		: "POST",
			dataType 	: "JSON",
			data		: {
				accao	: "delete",

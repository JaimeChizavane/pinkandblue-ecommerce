		...
		<div class="dev-col l9">
			...
			<div class="dropdown">
			  ...
			  <div class="dropdown-content">
				<a href="#" class="j_cria_nova_subcategoria" data-tipo="<?php echo $_GET["tipo"]?>">Adicionar Nova</a>
			  </div>
			</div>
		</div>
	</div>
...
$(document).ready(function()
{
	$('#results').DataTable({
		...
		'language'			: {
			...
			"sSearch"		: "Pesquisar:",
			"sSearchPlaceholder" : "nome do subcategoria...",
			"paginate"		: {
				"first"			: "Primeiro",
				"last"			: "Ultimo",
				"next"			: "Proximo",
		...
		'ajax'		 		: {
			'url' 			: "<?php echo ROOT_URL?>subcategorias/listarSubcategorias/",
			'type' 			: 'POST',
			'data'			: {
	...
	{
		$.ajax({
			url 		: "<?php echo ROOT_URL?>bairros/removerBairros/",
			method 		: "POST",
			dataType 	: "JSON",
			data		: {
				accao	: "delete",

<div class="dev-container">
	<div class="dev-border dev-white dev-padding dev-margin-bottom">
		<div class="dev-col l3">
				<h1 class="dev-large dev-margin-0"><i class="fa fa-users"></i> Clientes - Home</h1>
		</div>
	</div>
...
$(document).ready(function()
{
	$('#results').DataTable({
		...
		'language'			: {
			...
			"sSearch"		: "Pesquisar:",
			"sSearchPlaceholder" : "nome do cliente...",
			"paginate"		: {
				"first"			: "Primeiro",
				"last"			: "Ultimo",
				"next"			: "Proximo",
		...
		'ajax'		 		: {
			'url' 			: "<?php echo ROOT_URL?>clientes/listarClientes/",
			'type' 			: 'POST'
		},
		"columnDefs":[
		   {
	...
	{
		$.ajax({
			url 		: "<?php echo ROOT_URL?>clientes/removerClientes/",
			method 		: "POST",
			dataType 	: "JSON",
			data		: {
				accao	: "delete",
...
<script src="<?php echo ROOT_URL;?>assets/controllers/cliente.js"></script>
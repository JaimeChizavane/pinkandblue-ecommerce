	...
	<div class="dev-border dev-white dev-padding dev-margin-bottom">
		...
		<div class="dropdown">
		  ...
		  <div class="dropdown-content">
			<a href="#" class="j_cria_novo_categoria">Adicionar Novo</a>
...
$(document).ready(function()
{
	$('#results').DataTable({
		...
		'language'			: {
			...
			"sSearch"		: "Pesquisar:",
			"sSearchPlaceholder" : "nome do utilizador...",
			"paginate"		: {
				"first"			: "Primeiro",
				"last"			: "Ultimo",
				"next"			: "Proximo",
		...
		'ajax'		 		: {
			'url' 			: "<?php echo ROOT_URL?>users/listarUsers/",
			'type' 			: 'POST'
		},
		"columnDefs":[
		   {
	...
	{
		$.ajax({
			url 		: "<?php echo ROOT?>categorias/removerCategorias/",
			method 		: "POST",
			dataType 	: "JSON",
			data		: {
				accao	: "delete",

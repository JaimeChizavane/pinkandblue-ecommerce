	...
	<div class="dev-border dev-white dev-padding dev-margin-bottom">
		...
		<div class="dropdown">
		  ...
		  <div class="dropdown-content">
			<a href="#" class="j_cria_novo_banner" data-tipo="<?php echo $_GET["tipo"]?>">Adicionar Nova</a>
		  </div>
		</div>
	</div>
...
$(document).ready(function()
{
	$('#results').DataTable({
		...
		'language'			: {
			...
			"sSearch"		: "Pesquisar:",
			"sSearchPlaceholder" : "nome da banner...",
			"paginate"		: {
				"first"			: "Primeiro",
				"last"			: "Ultimo",
				"next"			: "Proximo",
		...
		'ajax'		 		: {
			'url' 			: "<?php echo ROOT_URL?>banners/listarBanners/",
			'type' 			: 'POST',
			'data'			: {
	...
	{
		$.ajax({
			url 		: "<?php echo ROOT_URL?>banners/removerBanners/",
			method 		: "POST",
			dataType 	: "JSON",
			data		: {
				accao	: "delete",

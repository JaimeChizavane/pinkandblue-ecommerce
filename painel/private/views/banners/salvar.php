<div class="dev-container">	
	<?php 
		$uteis 		= new Uteis;
		$id 		= (int) $_GET['id'];
		$uteis->query('SELECT * FROM banners WHERE id =:id');
		$uteis->bind(':id',$id);
		$uteis->execute();
	...
	<div class="dev-row-padding dev-margin-bottom" style="">
		<div class="dev-sidebar dev-collapse dev-border dev-grey" style="z-index:43;width:270px;" >
			<div class="dev-bar-block dev-animate-right" id="banners" >
				<div class="dev-bar-item dev-border-bottom dev-white">Banners - Salvar</div>
				<ul class="dev-ul dev-hoverable dev-large j_detalhes_da_banner">		
					<li style="padding:0;"><a href="#descricao_da_banner" class="dev-bar-item dev-large">Descrição</a></li>
					<li style="padding:0;"><a href="#foto_principal_da_banner" class="dev-bar-item dev-large">Foto Principal</a></li>
				</ul>	
			</div>	
		</div>
		<div class="dev-main" style="margin-left:270px;"><!--Aqui Inicia A Div para cadastro dos dados da Banner-->			
			<div class="dev-border dev-white dev-padding">
				<h1 class="dev-border-bottom dev-text-grey" id="descricao_da_banner" style="margin-bottom:0;">Descrição</h1>
				<form name="salva_banner" class="" style="margin-top:0;margin-bottom:0;" method="POST" id="salva_banner" action="<?php $_SERVER["PHP_SELF"];?>">
					<div class="dev-row-padding">
						<input type="hidden" value="<?php echo $id;?>" name="id">
						<p>
							<label class="dev-large" for="nome">Nome</label>
							<input class="dev-input dev-border dev-large dev-round-xlarge" type="text" name="nome" id="nome" value="<?php echo $viewmodel["nome"]?>" placeholder="Informe o nome da Banner" required>
						</p>
							...
							<iframe name="richTextField" id="richTextField" style="border:#ddd 1px solid; width:100%; height:300px;background-color:#fff;" class="dev-round-xlarge dev-border"></iframe>					
					</div>	
						...
						<div class="dev-half">
							<p>
								...
								<select class="dev-select dev-border dev-large dev-round-xlarge" name="tipo" id="tipo" required>
									<option value="" disabled selected>Informe o tipo de banner</option>
						...
						<div class="dev-half">
							<p>
								...
								<select class="dev-select dev-border dev-large dev-round-xlarge" name="status" id="status" required>
									<option value="" disabled selected>Informe o status da Banner</option>
					...
					<p class="j_banner">
						<input type="submit" class="dev-button dev-flat-belize-hole j_salva_banner" name="salvar_contacto" value="Salvar&nbsp; ❯">
				...
				<div class="dev-white" style="padding-top:0;">
					<h1 class="dev-border-bottom dev-text-grey" id="foto_principal_da_banner" style="margin-bottom:0;margin-top:0;">Foto Principal</h1>
		...
		</div><!--Aqui Finaliza A Div para cadastro dos dados da Banner-->
	</div>
</div>
<style>
	button{
...
$(document).ready(function(){
  ...
  $(".j_detalhes_da_banner > li > a").on('click', function(event) {
...
var theForm = document.getElementById("salva_banner");
...
<script src="<?php echo ROOT_URL;?>assets/controllers/banner.js"></script>
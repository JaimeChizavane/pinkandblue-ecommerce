<div class="dev-container">	
	<?php 
		$uteis 		= new Uteis;
		$id 		= (int) $_GET['id'];
		$uteis->query('SELECT * FROM marcas WHERE id =:id');
		$uteis->bind(':id',$id);
		$uteis->execute();
	...
	<div class="dev-row-padding dev-margin-bottom" style="">
		<div class="dev-sidebar dev-collapse dev-border dev-grey" style="z-index:43;width:270px;" >
			<div class="dev-bar-block dev-animate-right" id="marcas" >
				<div class="dev-bar-item dev-border-bottom dev-white">Marcas - Salvar</div>
				<ul class="dev-ul dev-hoverable dev-large j_detalhes_da_marca">		
					<li style="padding:0;"><a href="#descricao_da_marca" class="dev-bar-item dev-large">Descrição</a></li>
					<li style="padding:0;"><a href="#foto_principal_da_marca" class="dev-bar-item dev-large">Foto Principal</a></li>
				</ul>	
			</div>	
		</div>
		<div class="dev-main" style="margin-left:270px;"><!--Aqui Inicia A Div para cadastro dos dados da Subcategoria-->			
			<div class="dev-border dev-white dev-padding">
				<h1 class="dev-border-bottom dev-text-grey" id="descricao_da_marca" style="margin-bottom:0;">Descrição</h1>
				<form name="salva_marca" class="" style="margin-top:0;margin-bottom:0;" method="POST" id="salva_marca" action="<?php $_SERVER["PHP_SELF"];?>">
					<div class="dev-row-padding">
						<input type="hidden" value="<?php echo $id;?>" name="id">
						<p>
							<label class="dev-large" for="nome"><?php if($_GET["tipo"] == "automovel") echo "Modelo"; else echo "Marca";?></label>
							<input class="dev-input dev-border dev-large dev-round-xlarge"  type="text" name="nome" id="nome" value="<?php echo $viewmodel["nome"]?>" placeholder="<?php if($_GET["tipo"] == "automovel") echo "Modelo"; else echo "Marca";?>" required>
						</p>
					...
					<p class="j_marca">
						<input type="submit" class="dev-button dev-flat-belize-hole j_salva_marca" name="salvar_contacto" value="Salvar&nbsp; ❯">
				...
				<div class="dev-white" style="padding-top:0;">
					<h1 class="dev-border-bottom dev-text-grey" id="foto_principal_da_marca" style="margin-bottom:0;margin-top:0;">Foto Principal</h1>
...
$(document).ready(function(){
  ...
  $(".j_detalhes_da_marca > li > a").on('click', function(event) {
...
var theForm = document.getElementById("salva_marca");

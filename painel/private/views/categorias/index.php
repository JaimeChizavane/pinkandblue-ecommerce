<div class="dev-container">
	<div class="dev-border dev-white dev-padding dev-margin-bottom">
		<div class="dev-col l3">
				<h1 class="dev-large dev-margin-0"><i class="fa fa-tag"></i> Categorias - Home</h1>
		</div>
		<div class="dev-col l9">
			...
			<div class="dropdown">
			  ...
			  <div class="dropdown-content">
				<a href="#" class="j_cria_nova_categoria" data-tipo="<?php echo $_GET["tipo"]?>">Adicionar Nova</a>
			  </div>
			</div>
		</div>
	</div>
...
$(document).ready(function()
{
	$('#results').DataTable({
		...
		'language'			: {
			...
			"sSearch"		: "Pesquisar:",
			"sSearchPlaceholder" : "nome da categoria...",
			"paginate"		: {
				"first"			: "Primeiro",
				"last"			: "Ultimo",
				"next"			: "Proximo",
		...
		'ajax'		 		: {
			'url' 			: "<?php echo ROOT_URL?>categorias/listarCategorias/",
			'type' 			: 'POST',
			'data'			: {
	...
	{
		$.ajax({
			url 		: "<?php echo ROOT_URL?>categorias/removerCategorias/",
			method 		: "POST",
			dataType 	: "JSON",
			data		: {
				accao	: "delete",
